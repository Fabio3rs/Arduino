...
public class Serial implements SerialPortEventListener {
  ...
  public Serial() throws SerialException {
    this(PreferencesData.get("serial.port"),
      ...
      !BaseNoGui.getBoardPreferences(new PreferencesProxy()).getBoolean("serial.disableRTS"),
      !BaseNoGui.getBoardPreferences(new PreferencesProxy()).getBoolean("serial.disableDTR"));
  }
